        ...
        <div class="w-full flex flex-column bg-white rounded-lg px-12 py-18">
            <form class="flex flex-col" @submit.prevent="handleLogin">
                ...
                <div class="relative mt-4">
                    <input class="border rounded-lg pr-4 pl-8 py-2" v-model="login" type="text" autofocus="true" />
                ...
                <button class="w-20 rounded-lg bg-rose-400 mt-4 transition hover:bg-rose-500 active:bg-rose-600">
                    Login
                </button>
                <div class="mt-4">
